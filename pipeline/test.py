...
os.makedirs('results/wtq-tiny/tf_examples', exist_ok=True)
os.makedirs('results/wtq-tiny/model', exist_ok=True)
with open('results/wtq-tiny/model/checkpoint', 'w') as f:
  f.write('model_checkpoint_path: "model.ckpt-0"')
for suffix in ['.data-00000-of-00001', '.index', '.meta']:
  shutil.copyfile(f'tapas_wtq_wikisql_sqa_inter_masklm_tiny_reset/model.ckpt{suffix}', f'results/wtq-tiny/model/model.ckpt-0{suffix}')


max_seq_length = 512
vocab_file = "tapas_wtq_wikisql_sqa_inter_masklm_tiny_reset/vocab.txt"
